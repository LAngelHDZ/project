<div>
    ...
    <div class="mt-5">
        <select name="actividad" id="actividad" class="bg-grey-lighter border border-grey-lighter text-grey-darker py-3 px-4 pr-8 rounded" wire:model.defer="idUnidad">
            <option value="" selected>Seleccione Unidad</option>
            @foreach($listUnidades as $item)
            <option class="font-sans" value="{{ $item->idTema }}">
        ...
        <div class="flex flex-col w-full h-auto ">
            ...
            <div class="flex w-full h-auto justify-center items-center">
                <div class="flex w-10/12 h-auto py-3 justify-center items-center text-2xl font-bold">
                    Agregar Calificacion de Unidad
                </div>
...
<script>
    ...
    window.addEventListener('closeModalCalficaciones',event => {
        ...
        swal("Good job!", "Se agrego la calificacion de la Unidad!", "success");
    })
    ...
    window.addEventListener('calificacionExiste', event => {
        swal("Information!", "Ya hay una calificacion capturada del alumno de la unidad seleccionada!", "info");
    })
</script>
